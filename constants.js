...
export const questions = {
  ...
  {"_id":"2","text":"In a queue, three elements 33, 27, and 12 are enqueued in this order. After the element  45 is enqueued to this queue, two (2) elements are retrieved (or dequeued). Which of  the following is the second element to be retrieved? ","answers":["12","27","33","45"],"correctAnswer":"1"}
